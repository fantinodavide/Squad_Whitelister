...
<template>
	<popup ref="popupLogin" title="Edit Clan" @cancelBtnClick="$emit('cancelBtnClick', $event)" @confirmBtnClick="confirmBtnClick">
		...
		<label>Player Limit<input name="player_limit" type="number" placeholder="&infin;" style="width: 100px" :value="clan_data.player_limit" optional /></label>
